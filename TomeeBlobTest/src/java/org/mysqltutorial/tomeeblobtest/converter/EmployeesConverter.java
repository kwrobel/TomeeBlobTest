...
@FacesConverter(value = "employeesConverter")
public class EmployeesConverter implements Converter {

    private EmployeesFacade ejbFacade;
    ...
    private EmployeesFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(EmployeesFacade.class).get();
